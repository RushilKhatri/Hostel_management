  ...
  return (
    <div className="mainhostel">
      ...
      <div className="container-room">
        ...
        <div className="table-wrapper" style={{ maxHeight: '450px', overflowY: 'auto', marginTop: '1rem' }}>
          <div className="row">
        ...
        {dataSent && <div className="alert alert-success">Data Updated Successfully!</div>}
